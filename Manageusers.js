      ...
      return (
        ...
        source={require('./assets/photo.jpg')}>
          <UserInfo>
            ...
            <Icon.Button name ="edit" backgroundColor= "./assets/photo.jpg" onPress={() => Rootnavigation.navigate('Edit')} size={30}></Icon.Button>
          <Icon.Button name ="delete" backgroundColor= "./assets/photo.jpg" onPress={() => Rootnavigation.navigate('Edit')} size={30}></Icon.Button>
